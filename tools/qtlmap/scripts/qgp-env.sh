#!/bin/bash
# Initialisation des variables d environnement pour l'execution des applications QGP
# 
# - Recensement de toute les applications genetiques
# - Initilisation des variables lie à openmp
# - Initialisation d'un indice de carte GPU pour attribuer un ID unique à chaque application
#     ID_QGP_GPU. 
...
#
#
# Les scripts doivent charger l'environnement par > source qgp-env.sh 
# root des logiciels
